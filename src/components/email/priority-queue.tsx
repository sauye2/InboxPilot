...
export function PriorityQueue({
  ...
  return (
    <div className="liquid-glass flex h-[860px] max-h-[calc(100vh-4rem)] flex-1 flex-col rounded-2xl border-white/70 bg-white/34 p-5 shadow-2xl shadow-black/20 ring-1 ring-white/45">
