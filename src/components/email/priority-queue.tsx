...
export function PriorityQueue({
  ...
  if (items.length === 0) {
    return (
      <div className="liquid-glass flex h-[900px] flex-1 flex-col items-center justify-center rounded-2xl border-dashed border-black/15 bg-white/64 p-8 text-center">
  ...
  return (
    <div className="liquid-glass flex h-[900px] flex-1 flex-col overflow-hidden rounded-2xl border-white/70 bg-white/34 p-5 shadow-2xl shadow-black/20 ring-1 ring-white/45">
